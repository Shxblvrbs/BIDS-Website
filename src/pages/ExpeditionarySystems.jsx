...
import ExpeditionarySystemsBody from '../components/ExpeditionarySystemsBody';

const ExpeditionarySystems = () => {
  ...
  return (
    ...
    >
      ...
      Built for the swift establishment of forward-operating bases, these expeditionary solutions provide modular power generation, climate-controlled shelters, and transportable support units engineered for austere environments. Acting as mission-critical hubs for base operations, humanitarian aid, and emergency response—featuring containerized equipment suites, hybrid energy systems, and ruggedized communications nodes—they guarantee uninterrupted support and robust operational resilience.
      </p>
      ...
      <div className="about__image mt-16 flex justify-center opacity-0">
        <div className="relative p-4 rounded-lg bg-white/10 backdrop-blur-md">
          ...
          <img
            src="/img/ExpeditionarySystems.png"
            alt="About"
...
export default ExpeditionarySystems;
