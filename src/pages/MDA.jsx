...
import MDABody from '../components/MDABody';
...
const MDA = () => {
  ...
  return (
    ...
    >
      ...
      Achieve unparalleled maritime domain awareness with our fleet of Autonomous Surface Vehicles (ASVs) and Unmanned Surface Vehicles (USVs), delivering real-time surveillance, rapid threat detection, and seamless data fusion to safeguard coastal and open-ocean operations.
      </p>
