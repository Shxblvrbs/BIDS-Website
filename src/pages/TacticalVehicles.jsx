...
import TacticalVehiclesBody from '../components/TacticalVehiclesBody';

const TacticalVehicles = () => {
  ...
  return (
    ...
    >
      ...
      Our tactical vehicles are engineered for operator-centric performance, offering intuitive controls, rapid deployment capability, and all-terrain mobility for mission-critical operations. They serve as powerful assets for reconnaissance, troop transport, and command-and-control scenarios—featuring modular armor packages, integrated sensor suites, and secure communications that deliver real-time situational awareness and unmatched tactical advantage.
      </p>
...
export default TacticalVehicles;
