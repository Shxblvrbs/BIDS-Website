...
import CBRNBody from '../components/CBRNBody';
...
const CBRN = () => {
  ...
  return (
    ...
    >
      ...
      Engineered for rapid identification and neutralization of chemical, biological, radiological, nuclear, and explosive hazards, our CBRN & EOD bomb-detection suite combines high-sensitivity multi-spectral sensors, portable mass spectrometry, and real-time gamma/neutron spectrometry with robotic deployment platforms for safe, stand-off operations. Featuring integrated threat-mapping software, encrypted data links, and AI-driven anomaly analysis, it delivers pinpoint detection, automated sampling, and instant diagnostic feedback—ensuring operators can assess and mitigate risks with confidence and speed in the most hazardous environments.
      </p>
