...
useGSAP(() => {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-x-hidden bg-black">
      ...
      <Bounded alt="Unmanned Systems" className="overflow-hidden bg-black py-16 text-white md:py-24">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-3 lg:grid-rows-[auto,auto]">
          ...
          >
            <img
              src="/img/UnmannedSystemsBig.png"
              alt="Feature"
          ...
          >
            <img
              src="/img/UnmannedSystemsSmall.png"
              alt="Feature Detail"
            ...
            <div className="flex justify-between p-10 pt-4">
              <div className="space-y-1">
                ...
                <a
                  href="/products-and-services/air/unmanned-systems"
