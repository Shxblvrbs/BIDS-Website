...
import PostConflictBody from '../components/PostConflictBody';
...
const PostConflict = () => {
  ...
  return (
    ...
    >
      ...
      Accelerate recovery in post-conflict zones with our end-to-end reconstruction solutions—combining infrastructure renewal, governance support, and community engagement to restore stability and spark sustainable growth.
      </p>
