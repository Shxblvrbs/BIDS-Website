...
import IBDBody from '../components/IBDBody';
...
const IBD = () => {
  ...
  return (
    ...
    >
      ...
      Empower your organization to expand into new markets with our end-to-end business development and capture expertise. We blend deep regional insights, proactive market intelligence, and strategic alliance-building to identify, qualify, and secure pivotal contracts across the globe.
      </p>
