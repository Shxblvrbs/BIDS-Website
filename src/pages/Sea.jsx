...
useGSAP(() => {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-x-hidden bg-black">
      ...
      <Bounded alt="Maritime Domain Awareness" className="overflow-hidden bg-black py-16 text-white md:py-24">
          ...
          >
            ...
            <div className="flex justify-between p-10 pt-4">
              <div className="space-y-1">
                ...
                <a
                  href="/products-and-services/sea/maritime-domain-awareness"
