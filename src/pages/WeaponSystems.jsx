...
import WeaponSystemsBody from '../components/WeaponSystemsBody';
...
const WeaponSystems = () => {
  ...
  return (
    ...
    >
      ...
      Designed for uncompromising reliability in high-intensity theaters, these weapon systems combine adaptive targeting modules, recoil-mitigation technology, and configurable munition bays to suit any mission profile. AI-driven fire-control algorithms fuse data from multi-spectral sensors, enabling instantaneous threat identification and precision engagement under fire. Networked through secure tactical datalinks, they support coordinated strikes, remote status monitoring, and predictive maintenance to keep your force striking hard, fast, and without interruption.
      </p>
